...
<div class="card" >
 <!-- <img src="images/image.png" class="card-img-top" width="300" alt="" /> -->
  <div class="card-body" id="ModulBody">
    <p style="--groupcolor: {color}" class="Modulgruppe">{gruppe}</p>
    <a class="Modulname" id="Modulname" data-toggle="modal" data-target="#exampleModalCenter">{name} </a>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
          <div class="col"><h5 class="modal-title" id="exampleModalLongTitle">{name}</h5></div>
          <div class="col"><span class="badge" style="--badgeBG: {color}" >{badge} ECTS</span></div>
